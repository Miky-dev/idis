...
def esegui_profilo_uscita(testo: str):
    ...
    try:
        from .tools_mail import _ids_visti
...
def _uscita_step_learning():
    t1 = time.time()
    try:
        from .tools_routine_learning import rileva_e_registra
...
def _rientro_step_mail():
    ...
    time.sleep(3)
    try:
        from .tools_mail import ottieni_servizio_gmail, _filtro_locale, _decodifica_body, classifica_mail_con_llm
